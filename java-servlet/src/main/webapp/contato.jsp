    ...
    <nav class="navbar navbar-expand-lg text-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link link-light" href="contato.html">Contato</a>
                    </li>
        ...
        <div class="container container-form formulario col-md-5" >
            <form id="contactForm" class="needs-validation border-primary p-4"
                novalidate>
                <h1 class="destaque">Pensando em viajar? Venha fazer um
                    orçamento conosco!</h1>
                <p>Envie sua mensagem e em poucos minutos um de nossos
                        agentes entrará em contato com você.</strong></p>
                <div class="form-row">
                    <div class="form-group">
                        <label for="validationCustomNome"><strong>Nome Completo</strong></label>
                        <input type="text" class="form-control"
                            id="validationCustomNome"
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="validationCustomDestino"><strong>Destino
                                desejado</strong></label>
                        <input type="text" class="form-control"
                            id="validationCustomDestino"
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group">
                        <label for="validationCustomTelefone"><strong>Telefone</strong></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"
                                    id="inputGroupPrependTelefone">📞</span>
                            </div>
                            <input type="tel" class="form-control"
                                style="border-radius: 5px;"
                                id="validationCustomTelefone"
                                placeholder="Ex.: 21 99999-9999"
                                aria-describedby="inputGroupPrependTelefone"
                                required>
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"
                                    id="inputGroupPrependEmail">✉</span>
                            </div>
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group">
                        <label for="validationCustomMensagem"><strong>Mensagem</strong></label>
                        <textarea class="form-control"
                            id="validationCustomMensagem"
                            placeholder="Solicito orçamento para o destino..."
                            required></textarea>
