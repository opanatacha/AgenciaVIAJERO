                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle link-light"
                           href="destinos.html" role="button"
                           data-bs-toggle="dropdown" aria-expanded="false">
                            Destinos
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                   href="destinos.html#mais-visitados">Mais
                                Visitados</a></li>
                            <li><a class="dropdown-item"
                                   href="destinos.html#excursoes">Excursões</a></li>
                            <li><a class="dropdown-item"
                                   href="destinos.html#internacionais">Internacionais</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
...
<div class="container" style="border-radius: 10px; margin-bottom: 30px;">
    <div class="d-flex flex-column">
        <div class="mb-4">
            <a href="maisvisitados.jsp">
                <section id="mais-visitados" class="ftco-section ftco-no-pt">
                    <div class="card text-bg-dark">
                        <img src="img/Rio-de-janeiro.jpg" class="card-img card-image img-fluid" alt="imagem promo">
                        <div class="card-img-overlay">
                            <h3 class="card-title card-custom">Mais Visitados</h3>
                            <p class="card-text card-custom">Aqui você fica sabendo os lugares mais visitados pelos nossos clientes.</p>
                            <p class="card-text card-custom"><small>Dê um clique e confira!</small></p>
                        </div>
                    </div>
                </section>
            </a>
        ...
        <div class="mb-4">
            <a href="excursoes.jsp">
                <section id="excursoes" class="ftco-section ftco-no-pt">
                    <div class="card text-bg-dark">
                        <img src="img/Parqueaquatico.jpg" class="card-img card-image img-fluid" alt="Parque aquatico">
                        <div class="card-img-overlay">
                            <h2 class="card-title card-custom">Excursões</h2>
                            <p class="card-text card-custom">Pensou em dar um passeio "bate e volta" com a família?</p>
                            <p class="card-text card-custom"><small>Basta clicar e escolher o lugar ideal!</small></p>
                        </div>
                    </div>
                </section>
            </a>
        ...
        <div class="mb-4">
            <a href="internacionais.jsp">
                <section id="internacionais" class="ftco-section ftco-no-pt">
                    <div class="card text-bg-dark">
                        <img src="img/Paris-Franca.jpg" class="card-img card-image img-fluid" alt="Cidade de Paris">
                        <div class="card-img-overlay">
                            <h2 class="card-title card-custom">Internacionais</h2>
                            <p class="card-text card-custom">Que tal conhecer destinos incríveis pelo mundo?</p>
                            <p class="card-text card-custom"><small>Clique aqui que a VIAJERO te leva!</small></p>
                        </div>
                    </div>
                </section>
            </a>
                    ...
                    <div class="col-md">
                        <div class="ftco-footer-widget mb-4 ml-md-5">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="destinos.html#mais-visitados"
                                        class="py-2 d-block text-black">Mais
                                        visitados</a></li>
                                <li><a href="destinos.html#excursoes"
                                        class="py-2 d-block text-black">Excursões</a></li>
                                <li><a href="destinos.html#internacionais"
